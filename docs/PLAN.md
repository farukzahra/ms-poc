# Enterprise AI Sales Intelligence Agent — POC Plan

> Full specification for the Microsoft Azure AI Solution Engineering POC.
> Source: `PLAN.MD.txt`. Last updated: 2026-07-30.
...
4. [Target Azure architecture](#4-target-azure-architecture)
5. [Why these technologies](#5-why-these-technologies)
6. [Technology stack](#6-technology-stack)
7. [Repository structure](#7-repository-structure)
8. [Azure resource group](#8-azure-resource-group)
9. [Azure budget protection](#9-azure-budget-protection)
...
16. [Enterprise APIs](#16-enterprise-apis)
17. [MCP Server](#17-mcp-server)
18. [Agent](#18-agent)
19. [System prompt](#19-agent-system-prompt)
20. [Example conversation](#20-example-conversation)
21. [Fact vs recommendation](#21-fact-vs-recommendation)
...
35. [Cost strategy](#35-cost-strategy)
36. [Development strategy (phases)](#36-development-strategy)
37. [Demo dataset](#37-demo-dataset)
38. [Demo customers](#38-demo-customers)
39. [Demo scenarios](#39-demo-scenarios)
40. [ADRs](#40-architecture-decision-records)
41. [Testing](#41-testing)
42. [Evaluation](#42-evaluation)
43. [Performance](#43-performance)
44. [Production architecture](#44-production-architecture)
45. [Security evolution](#45-security-evolution)
46. [AI architecture evolution](#46-ai-architecture-evolution)
47. [Business metrics](#47-business-metrics)
48. [Final demo](#48-final-demo)
49. [Interview talking points](#49-interview-talking-points)
50. [Architectural principle](#50-important-architectural-principle)
51. [Definition of Done](#51-definition-of-done)
52. [First implementation task](#52-first-implementation-task)
